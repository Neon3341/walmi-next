...
export function CartRightSideInner({ }) {
    ...
    return (
        <>
            <div className="mb-16 col-span-2 rounded-2xl py-2 px-4 mt-2 bg-neutral-100">
            ...
            <div className="fixed items-center left-0 right-0 bottom-0 pb-6 px-4 pt-2 flex justify-between mb-12 rounded-ss-2xl rounded-se-2xl bg-green-100 w-full min-h-16">
                <p className="font-bold text-[20px] text-green-600 rounded-2xl w-fit leading-4">{priceSpaces(cartCalc?.sum)}  <span className="text-base">₽ </span></p>
